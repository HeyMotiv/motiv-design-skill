...
const dir = path.join(__dirname, '..', 'docs', 'examples', 'Follower', '1 Participant Onboarding');
...
http.createServer((req, res) => {
  ...
  if (req.url === '/' || req.url === '/index.html') {
    ...
    let html = '<html><body style="font-family:sans-serif;padding:20px;"><h2>Participant Onboarding</h2><ul>';
...
}).listen(port, () => console.log('Serving onboarding on http://localhost:' + port));
